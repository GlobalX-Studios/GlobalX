...
public class GroupManager {
    ...
    public static void loadGroups() {
        for(String group : GlobalX.getMainConfig().getSection("Groups").getKeys()) {
            ...
            String globalChatFormat = GlobalX.getMainConfig().getString("Groups." + group + ".GlobalChatFormat");
            String staffChatFormat = GlobalX.getMainConfig().getString("Groups." + group + ".StaffChatFormat");
            ...
            String nickFormat = GlobalX.getMainConfig().getString("Groups." + group + ".NicknameFormat");

            if (prefix.isEmpty() || cooldown.isNaN() || globalChatFormat == null || permission == null || prefixes.isEmpty()) {
            ...
            Group groupInstance = new Group(prefix, cooldown, globalChatFormat, staffChatFormat, permission, prefixes, nickFormat, group);
